...
const TITLE = '🎰 FREE SPINS & NEW FEATURES!';
const BODY = 'Your daily FREE SPIN is waiting! 🎁 Win up to 1000 WLD in the new Slot Machine. Plus: Check out the new Media Tab & Daily Missions! 🚀 Don\'t miss out!';
