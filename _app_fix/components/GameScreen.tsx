...
export default function GameScreen({ userHash }: GameScreenProps) {
    ...
    const [activeTab, setActiveTab] = useState(initialTab && ['collect', 'upgrades', 'missions', 'leaderboard', 'premium', 'convert', 'roulette', 'survey', 'media'].includes(initialTab) ? initialTab : 'collect')
