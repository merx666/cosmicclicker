...
// Keep title under 30 characters to pass validation
const TITLE = '👥 Invite Friends, Get 50k!';
const BODY = 'Boost your balance! Get 50,000 particles for every friend you invite. Plus, they get a 25,000 particles head start! Start sharing your referral link now! 🚀';
...
async function main() {
    console.log('\n👥 REFERRALS ANNOUNCEMENT - MASS NOTIFICATION');
    console.log('--------------------------------------------------');
