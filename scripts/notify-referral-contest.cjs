...
// Fixed title: strictly 28 characters, no emojis to prevent byte length issues
const TITLE = 'Win 50 WLD: Referral Contest';
const BODY = 'The race is ON! Invite friends and dominate the leaderboard. The TOP 5 referrers will walk away with 50 WLD each. Start sharing your link and win big today! 🚀🏆';
...
async function main() {
    console.log('\n🏆 REFERRAL CONTEST REMINDER - MASS NOTIFICATION');
    console.log('--------------------------------------------------');
