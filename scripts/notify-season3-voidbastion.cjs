...
const TITLE = '🏰 VOID BASTION IS LIVE!';
const BODY = 'Season 3 has officially started! 🚀 Command units, build defenses, protect the Void Bastion, and conquer the new Leaderboards for big prizes! Play now! ⚔️💎';
...
async function main() {
    console.log('\n🏰 VOID BASTION & SEASON 3 - MASS NOTIFICATION');
    console.log('--------------------------------------------------');
