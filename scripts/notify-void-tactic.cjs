...
const TITLE = '🚀 VOID TACTIC IS COMING!';
const BODY = 'Big things are brewing for our top $VOID holders! 💎 A brand-new game — Void Tactic — drops in days. The biggest holders can expect MASSIVE bonuses at launch. Hold strong. Rewards are coming! 🔥';
...
async function sendNotificationBatch(wallets) {
    ...
    console.log(`\n   ✅ Total notification sent to ${totalSent} users.`);
}

async function main() {
    console.log('\n🚀 VOID TACTIC - MASS NOTIFICATION');
    console.log('--------------------------------------------------');
