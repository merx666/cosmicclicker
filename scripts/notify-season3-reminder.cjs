...
const TITLE = '⚡ SEASON 3 IS COMING SOON!';
const BODY = 'The wait is almost over! Season 3 of Cosmic Clicker is coming soon with fresh rewards, new challenges, and bigger prizes. Get ready to dominate the leaderboard! 🏆🚀';
...
async function main() {
    console.log('\n⚡ SEASON 3 REMINDER - MASS NOTIFICATION');
    console.log('--------------------------------------------------');
