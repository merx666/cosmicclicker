## 2024-05-24 - Zustand global state anti-pattern
...
**Action:** Always use specific state selectors, and use `useShallow` from `zustand/react/shallow` when multiple properties must be selected to prevent unnecessary re-renders.
