...
export declare abstract class NodeExecutionContext implements Omit<FunctionsBase, 'getCredentials'> {
    ...
    getExecutionContext(): {
        ...
        source: "webhook" | "error" | "manual" | "cli" | "integrated" | "internal" | "retry" | "trigger" | "evaluation" | "chat";
        triggerNode?: {
            name: string;
            type: string;
        } | undefined;
    ...
    getMode(): "webhook" | "error" | "manual" | "cli" | "integrated" | "internal" | "retry" | "trigger" | "evaluation" | "chat";
