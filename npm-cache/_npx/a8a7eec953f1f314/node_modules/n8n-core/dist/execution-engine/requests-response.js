...
function initializeNodeRunData(runData, nodeName, parentNode, parentOutputIndex, parentRunIndex, actionMetadata, runIndex, parentOutputData) {
    runData[nodeName] ||= [];
...
function prepareRequestedNodesForExecution(workflow, currentNode, request, runIndex, runData, executionData) {
    ...
    for (const action of request.actions) {
        ...
        const nodeRunIndex = initializeNodeRunData(runData, node.name, parentNode, defaultParentOutputIndex, parentRunIndex, actionMetadata, runIndex, parentOutputData);
