...
let ErrorReporter = class ErrorReporter {
    ...
    async init({ beforeSendFilter, dsn, serverType, release, environment, serverName, releaseDate, withEventLoopBlockDetection, profilesSampleRate, tracesSampleRate, eligibleIntegrations = {}, healthEndpoint = 'healthz', }) {
