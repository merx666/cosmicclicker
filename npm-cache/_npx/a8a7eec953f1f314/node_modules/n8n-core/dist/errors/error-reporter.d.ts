...
export declare class ErrorReporter {
    ...
    init({ beforeSendFilter, dsn, serverType, release, environment, serverName, releaseDate, withEventLoopBlockDetection, profilesSampleRate, tracesSampleRate, eligibleIntegrations, healthEndpoint, }: ErrorReporterInitOptions): Promise<void>;
