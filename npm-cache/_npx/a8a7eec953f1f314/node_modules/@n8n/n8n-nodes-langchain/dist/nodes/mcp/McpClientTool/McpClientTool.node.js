...
class McpClientTool {
    ...
    async supplyData(itemIndex) {
        ...
        const tools = mcpTools.map((tool) => (0, logWrapper_1.logWrapper)((0, utils_1.mcpToolToDynamicTool)(tool, (0, utils_1.createCallTool)(tool.name, client, config.timeout, (errorMessage) => {
