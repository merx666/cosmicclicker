...
declare const VectorStoreRedis_base: {
    new (): {
        ...
        methods: {
            ...
            actionHandler?: {
                [functionName: string]: (this: ILoadOptionsFunctions, payload: import("n8n-workflow").IDataObject | string | undefined) => Promise<import("n8n-workflow").NodeParameterValueType>;
            };
        } | undefined;
