...
const tiktoken_1 = require("../../../utils/tokenizer/tiktoken");
const token_estimator_1 = require("../../../utils/tokenizer/token-estimator");
    ...
    async splitText(text) {
        try {
            ...
            if ((0, helpers_1.hasLongSequentialRepeat)(text)) {
                const splits = (0, token_estimator_1.estimateTextSplitsByTokens)(text, this.chunkSize, this.chunkOverlap, this.encodingName);
                return splits;
            }
            try {
                ...
                return (0, token_estimator_1.estimateTextSplitsByTokens)(text, this.chunkSize, this.chunkOverlap, this.encodingName);
            }
        }
        catch (error) {
            return [];
