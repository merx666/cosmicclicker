...
declare const VectorStoreWeaviate_base: {
    new (): {
        ...
        methods: {
            ...
            actionHandler?: {
                [functionName: string]: (this: import("n8n-workflow").ILoadOptionsFunctions, payload: IDataObject | string | undefined) => Promise<import("n8n-workflow").NodeParameterValueType>;
            };
        } | undefined;
