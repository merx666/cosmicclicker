...
async function processItem(ctx, itemIndex, item, operationMode, chunkingMode) {
    ...
    if (operationMode === 'documentLoader') {
        ...
        if (operationMode === 'nodeInputBinary') {
            ...
            processor = new N8nBinaryLoader_1.N8nBinaryLoader(ctx, 'options.', binaryDataKey, textSplitter);
        }
        else {
            processor = new N8nJsonLoader_1.N8nJsonLoader(ctx, 'options.', textSplitter);
        }
