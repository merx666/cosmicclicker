import { ActivateWorkflowDto, CreateWorkflowDto, ImportWorkflowFromUrlDto, TransferWorkflowBodyDto, UpdateWorkflowDto } from '@n8n/api-types';
...
export declare class WorkflowsController {
    ...
    archive(req: AuthenticatedRequest, _res: Response, workflowId: string): Promise<{
        checksum: string;
        name: string;
        description: string | null;
        active: boolean;
