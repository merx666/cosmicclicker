...
let FrontendService = class FrontendService {
    ...
    async getPublicSettings(includeMfaSettings) {
        const { defaultLocale, userManagement: { authenticationMethod, showSetupOnFirstLoad, smtpSetup }, sso: { saml: ssoSaml, ldap: ssoLdap, oidc: ssoOidc }, authCookie, previewMode, enterprise: { saml, ldap, oidc }, mfa, } = await this.getSettings();
