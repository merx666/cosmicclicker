...
import { Project, User, ProjectRelationRepository, SharedWorkflowRepository, UserRepository, SettingsRepository } from '@n8n/db';
...
export declare class OwnershipService {
    ...
    constructor(cacheService: CacheService, eventService: EventService, logger: Logger, passwordUtility: PasswordUtility, projectRelationRepository: ProjectRelationRepository, sharedWorkflowRepository: SharedWorkflowRepository, userRepository: UserRepository, settingsRepository: SettingsRepository);
