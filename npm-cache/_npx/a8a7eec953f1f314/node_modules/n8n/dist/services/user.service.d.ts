...
export declare class UserService {
    ...
    constructor(logger: Logger, userRepository: UserRepository, projectRepository: ProjectRepository, mailer: UserManagementMailer, urlService: UrlService, eventService: EventService, publicApiKeyService: PublicApiKeyService, roleService: RoleService, globalConfig: GlobalConfig, jwtService: JwtService, postHog: PostHogClient);
    ...
    private processInviteeIdInviterIdBasedInvite;
    getInvitationIdsFromPayload(payload: {
        token?: string;
        inviterId?: string;
        inviteeId?: string;
    }): Promise<{
