...
export declare class CollaborationState {
    ...
    setWriteLock(workflowId: Workflow['id'], userId: User['id']): Promise<void>;
    renewWriteLock(workflowId: Workflow['id'], userId: User['id']): Promise<void>;
    getWriteLock(workflowId: Workflow['id']): Promise<User['id'] | null>;
