...
class CloudAdapter extends baseAdapter_1.BaseAdapter {
    ...
    async createConnectorClientWithIdentity(identity, activity, headers) {
        ...
        if (activity.isAgenticRequest()) {
            ...
            if (((_a = activity.recipient) === null || _a === void 0 ? void 0 : _a.role) === agents_activity_1.RoleTypes.AgenticIdentity && activity.getAgenticInstanceId()) {
                // get agentic instance token
                const token = await tokenProvider.getAgenticInstanceToken((_b = activity.getAgenticInstanceId()) !== null && _b !== void 0 ? _b : '');
                connectorClient = connectorClient_1.ConnectorClient.createClientWithToken(activity.serviceUrl, token, headers);
            }
            else if (((_c = activity.recipient) === null || _c === void 0 ? void 0 : _c.role) === agents_activity_1.RoleTypes.AgenticUser && activity.getAgenticInstanceId() && activity.getAgenticUser()) {
                const scope = (_e = (_d = tokenProvider.connectionSettings) === null || _d === void 0 ? void 0 : _d.scope) !== null && _e !== void 0 ? _e : authConstants_1.ApxProductionScope;
                const token = await tokenProvider.getAgenticUserToken((_f = activity.getAgenticInstanceId()) !== null && _f !== void 0 ? _f : '', (_g = activity.getAgenticUser()) !== null && _g !== void 0 ? _g : '', [scope]);
                connectorClient = connectorClient_1.ConnectorClient.createClientWithToken(activity.serviceUrl, token, headers);
            }
            else {
            ...
            const scope = (_j = (_h = identity.azp) !== null && _h !== void 0 ? _h : identity.appid) !== null && _j !== void 0 ? _j : 'https://api.botframework.com';
            const token = await tokenProvider.getAccessToken(scope);
            connectorClient = connectorClient_1.ConnectorClient.createClientWithToken(activity.serviceUrl, token, headers);
        }
