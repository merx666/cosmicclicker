...
import WldBalance from './WldBalance'
...
export default function GameScreen({ userHash }: GameScreenProps) {
    ...
    // Subscription to volatile `particles` state moved to child component <WldBalance /> to prevent GameScreen re-render cascades on every tick.
