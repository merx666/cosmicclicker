...
export default function RouletteTab() {
    ...
    // Using useShallow to prevent RouletteTab from re-rendering on unrelated gameStore updates (like passive particle generation).
    // This component only subscribes to nullifierHash, particles, and addParticles.
    const { nullifierHash, particles, addParticles } = useGameStore(useShallow(state => ({
