...
export default function RouletteTab() {
    // ⚡ Bolt: Use useShallow to subscribe only to specific state properties.
    // 📊 Impact: Prevents RouletteTab from re-rendering every second when passive particles update unrelated state.
