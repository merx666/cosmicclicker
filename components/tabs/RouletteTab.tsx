...
export default function RouletteTab() {
    ...
    // Replaced full store destructuring with useShallow to select multiple properties.
    // Impact: Prevents RouletteTab from re-rendering on unselected state updates (like passive particle gen).
