...
export default function SurveyTab() {
    // ⚡ Bolt: Use direct state selector to prevent the component from tracking the whole store object.
    // 📊 Impact: Significantly improves performance by skipping re-renders when global state like `particles` updates.
