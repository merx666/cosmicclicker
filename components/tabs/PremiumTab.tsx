...
export default function PremiumTab() {
    const {
        premiumParticleSkin, premiumBackgroundTheme, premiumLuckyParticle, premiumOfflineEarnings, premiumDailyBonus, premiumVIP, vipTier, purchasePremiumUpgrade, equipSkin, equipTheme, unlockedSkins, unlockedThemes, claimDailyBonus, lastDailyBonusTime, loginStreak, nullifierHash, loadGameState
