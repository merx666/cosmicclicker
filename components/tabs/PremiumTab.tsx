...
export default function PremiumTab() {
    // ⚡ Bolt Optimization: Use useShallow to prevent unnecessary re-renders when unrelated global state (like particles) updates.
    // Reduces re-renders significantly during gameplay.
    const {
        premiumParticleSkin,
