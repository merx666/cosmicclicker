...
export default function PremiumTab() {
    // ⚡ Bolt: Subscribed only to specific state properties required for PremiumTab using useShallow.
    // 📊 Impact: Component no longer re-renders unnecessarily during fast global state changes.
    const {
        premiumParticleSkin,
