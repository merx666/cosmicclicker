...
export default function UpgradesTab() {
    // ⚡ Bolt: Destructured state through useShallow to prevent rendering on unused property updates.
    // 📊 Impact: UpgradesTab stays performant and isolated from global state spam.
    const {
        particles,
        upgradeClickPower,
